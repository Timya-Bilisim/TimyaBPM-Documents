...
<li><strong>İş Nesnesi:</strong> Sistemde daha önce oluşturulmuş bir iş nesnesi seçilir.</li>
...
<li><strong>Kolon Adı (Source Column Name):</strong> Verinin alındığı kaynağın kolon adını ifade eder.</li>
<li><strong>Kolon Görünen İsim:</strong> Tabloda bu kolonun kullanıcıya nasıl görüneceğini belirler.</li>
<li><strong>Kaynak Kolon Adı (Source Column):</strong> Verinin hangi kaynaktan alındığını gösterir.Kolon Adı ile aynıdır.</li>
<li><strong>Sıralı mı?:</strong> İlgili sütunun sıralanabilir olup olmadığını belirler. Evet/Hayır olarak işaretlenir.</li>
